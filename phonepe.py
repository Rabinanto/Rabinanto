...
if selected == "Home":
    ...
    image = Image.open("C:/Users/Sudharshan/PhonePe.png")
    st.image(image)
...
if selected == "Top Charts":
    ...
    with colum2:
        st.info(
                """
                #### !!! In this menu we can get insights like :
                - Overall ranking on a particular Year and Quarter.
                - Top 10 State, District, Pincode based on Total number of transaction on phonepe.
                - Top 10 State, District, Pincode based on Total phonepe users.
                - Top 10 mobile brands and its percentage.
                """
                )
